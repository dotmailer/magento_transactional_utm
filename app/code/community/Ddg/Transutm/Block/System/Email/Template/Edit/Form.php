...
class Ddg_Transutm_Block_System_Email_Template_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	/**
	 * Prepare layout.
	...
	protected function _prepareForm()
	{
		...
		$fieldset = $form->addFieldset('base_fieldset', array(
			'legend' => Mage::helper('adminhtml')->__('Template Information Local'),
			'class' => 'fieldset-wide'
		));
		 ...
		 * UTM data.
		 */
		$fieldset->addField('utm_source', 'text', array(
			'name'=>'utm_source',
			'label' => Mage::helper('adminhtml')->__('UTM Source'),
			'required' => false
		));
		$fieldset->addField('utm_medium', 'text', array(
			'name'=>'utm_medium',
			'label' => Mage::helper('adminhtml')->__('UTM Medium'),
			'required' => false
		));
		$fieldset->addField('utm_campaign', 'text', array(
			'name'=>'utm_campaign',
			'label' => Mage::helper('adminhtml')->__('UTM Campaign'),
			'required' => false
		));
